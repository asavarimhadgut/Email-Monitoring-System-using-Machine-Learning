...
new_text = ["Reminder: Our team meeting is scheduled for tomorrow at 10am in the conference room."]
...
accumulate_result = []
accumulate_result.extend([lr_count_prediction,lr_tfidf_prediction,nb_count_prediction,nb_tfidf_prediction,knn_count_prediction,knn_tfidf_prediction])
